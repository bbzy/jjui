...
var builtInActionScopes = map[string][]string{
	...
	"annotation.editor.save":                     {"annotation.editor"},
	"annotation.half_page_down":                  {"annotation"},
	"annotation.half_page_up":                    {"annotation"},
	"annotation.left":                            {"annotation"},
	"annotation.move_bottom":                     {"annotation"},
	"annotation.move_down":                       {"annotation"},
	"annotation.move_top":                        {"annotation"},
	"annotation.move_up":                         {"annotation"},
	"annotation.next_file":                       {"annotation"},
	"annotation.page_down":                       {"annotation"},
	"annotation.page_up":                         {"annotation"},
	"annotation.parent_revision":                 {"annotation"},
	"annotation.prev_file":                       {"annotation"},
	"annotation.right":                           {"annotation"},
	"annotation.select_down":                     {"annotation"},
	"annotation.select_up":                       {"annotation"},
	"annotation.target_picker":                   {"annotation"},
	"annotation.toggle_presentation":             {"annotation"},
	"annotation.toggle_wrap":                     {"annotation"},
	...
	"revisions.open_annotation":                  {"revisions"},
